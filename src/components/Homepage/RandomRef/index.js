...
function RandomRef() {
  ...
  return (
    <div className="randomRef w-2/5 h-[17rem] rounded-md py-8 px-10 flex flex-col justify-between text-[1.25rem] font-medium cursor-context-menu tablet:w-4/5 phone:py-4 phone:px-5 phone:text-[1.2rem]">
